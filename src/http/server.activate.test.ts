...
it('activate ставит указатель, повторная — перезаписывает', async () => {
  store.append('g1', makeEvent('GAME_CREATED', { gameId: 'g1', packId: 'p1', title: 'T', teamCount: 2, answerTimerSec: 45 }));
  store.append('g2', makeEvent('GAME_CREATED', { gameId: 'g2', packId: 'p1', title: 'T2', teamCount: 2, answerTimerSec: 45 }));
