<script lang="ts">
  ...
  export let title = '';
  export let width = 360;   // ширина диалога, px
...
<div class="overlay">
  <div class="dialog" role="dialog" aria-modal="true" style="width:{width}px">
...
<style>
  ...
  .dialog { background: var(--panel); border: 1px solid var(--border); border-radius: var(--r-card); box-shadow: var(--shadow-card); padding: 22px; max-width: calc(100vw - 32px); }
